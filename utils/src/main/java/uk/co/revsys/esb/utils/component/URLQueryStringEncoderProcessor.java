...
public class URLQueryStringEncoderProcessor implements Processor, ParameterAwareProcessor {
    ...
    public void process(Exchange exchng) throws Exception {
        String result = encoder.encodeQueryString(exchng.getIn().getBody(String.class), encoding);
